...
namespace Spiel_Des_Lebens
{
   public partial class Form2 : Form
   {
      ...
      private void get_new_actions()
      {
         ...
         action_0_btn.Image = getActionIcon(ui_interface.getActionOptionMainStat(0));
         action_1_btn.Image = getActionIcon(ui_interface.getActionOptionMainStat(1));
         action_2_btn.Image = getActionIcon(ui_interface.getActionOptionMainStat(2));
         action_3_btn.Image = getActionIcon(ui_interface.getActionOptionMainStat(3));
